...
const handlePrismaP2002Error = (err: Prisma.PrismaClientKnownRequestError): AppError => {
...
export const errorHandler = (err: unknown, req: Request, res: Response, next: NextFunction) => {
  // Use a localized type for errors with potential statusCode and status
  ...
  let error = err as EnhancedError;
